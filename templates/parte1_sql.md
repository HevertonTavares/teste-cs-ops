...
Observação: neste dataset, todos os clientes com queda acima de 50 por cento possuem evento de churn. Isso reforça queda abrupta de uso como um indicador forte para risco.
